    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <li class="breadcrumb float-sm-right"><a href="{{route('assignCourse.create')}}">Assign Course</a></li>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('course.destroy',$p->id)}}" method="post" class="m-0 p-0"
                                    ...
                                    <a class="dropdown-item success" href="{{route('assignCourse.edit',$p->id)}}"><i class="far fa-edit"></i></a>
                                    @csrf
                                    @method('delete')
