...
class RoleController extends Controller
{
    ...
    {
        $roles = Role::list()->get();
        return view('master.admin.roles.role-list', compact('roles'));
    }
    ...
    public function create($roleid = null)
    {
        ...
        if ($roleid) {
          //  Gate::authorize('action', Permission::edit_role);
...
//            return $role;
           ...
           // Gate::authorize('action', Permission::add_role);
        }
        if ($replicateid) {
...
//            return \request();
        ...
        return view('master.admin.roles.create-role', compact('menus', 'roles', 'role'));
    }
    ...
    public function store(RoleRequest $request)
    {
        ...
        return redirect()->route('role.list')->with('success', 'Role saved');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if (!$role) return back()->with('error', 'Role not found');
            ...
            return redirect()->route('role-list')->with('success', 'Role successfully deleted');
        }
    }
